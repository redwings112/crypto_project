...
export const LinkedinIcon = (props: IconProps) => (
  <Icon viewBox="0 0 33 33" fill="none" {...props}>
    <g id="Icon/linkedin-logo" clip-path="url(#clip0_422_8119)">
      <path
        id="Vector"
        d="M27.5 4.0415H5.5C4.94772 4.0415 4.5 4.48922 4.5 5.0415V27.0415C4.5 27.5938 4.94772 28.0415 5.5 28.0415H27.5C28.0523 28.0415 28.5 27.5938 28.5 27.0415V5.0415C28.5 4.48922 28.0523 4.0415 27.5 4.0415Z"
        stroke="#778092"
        stroke-width="2"
      ...
      <path
        id="Vector_4"
        d="M15.5 17.5415C15.5 16.6132 15.8687 15.723 16.5251 15.0666C17.1815 14.4103 18.0717 14.0415 19 14.0415C19.9283 14.0415 20.8185 14.4103 21.4749 15.0666C22.1313 15.723 22.5 16.6132 22.5 17.5415V22.0415"
        stroke="#778092"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
      ...
      <path
        id="Vector_5"
        d="M11.5 12.0415C12.3284 12.0415 13 11.3699 13 10.5415C13 9.71308 12.3284 9.0415 11.5 9.0415C10.6716 9.0415 10 9.71308 10 10.5415C10 11.3699 10.6716 12.0415 11.5 12.0415Z"
        fill="#778092"
      />
    </g>
    <defs>
      <clipPath id="clip0_422_8119">
        <rect
          ...
          height="32"
          fill="white"
          transform="translate(0.5 0.0415039)"
        />
      </clipPath>
    </defs>
  </Icon>
...
export const LinkedinIconActive = (props: IconProps) => (
  <Icon viewBox="0 0 33 33" fill="none" {...props}>
    <g id="Icon/linkedin-logo" clip-path="url(#clip0_422_7876)">
      <path
        id="Vector"
        d="M27.75 4.0415H5.75C5.19772 4.0415 4.75 4.48922 4.75 5.0415V27.0415C4.75 27.5938 5.19772 28.0415 5.75 28.0415H27.75C28.3023 28.0415 28.75 27.5938 28.75 27.0415V5.0415C28.75 4.48922 28.3023 4.0415 27.75 4.0415Z"
        stroke="#1ED760"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
      ...
      <path
        id="Vector_4"
        d="M15.75 17.5415C15.75 16.6132 16.1187 15.723 16.7751 15.0666C17.4315 14.4103 18.3217 14.0415 19.25 14.0415C20.1783 14.0415 21.0685 14.4103 21.7249 15.0666C22.3813 15.723 22.75 16.6132 22.75 17.5415V22.0415"
        stroke="#1ED760"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
      ...
      <path
        id="Vector_5"
        d="M11.75 12.0415C12.5784 12.0415 13.25 11.3699 13.25 10.5415C13.25 9.71308 12.5784 9.0415 11.75 9.0415C10.9216 9.0415 10.25 9.71308 10.25 10.5415C10.25 11.3699 10.9216 12.0415 11.75 12.0415Z"
        fill="#1ED760"
      />
    </g>
    <defs>
      <clipPath id="clip0_422_7876">
        <rect
          ...
          height="32"
          fill="white"
          transform="translate(0.75 0.0415039)"
        />
      </clipPath>
    </defs>
  </Icon>
...
export const SwitchIcon = (props: IconProps) => (
  <Icon width="36" height="36" viewBox="0 0 36 36" {...props}>
    ...
    />
    <path
      d="M18.75 21L21.75 24M21.75 24L24.75 21M21.75 24L21.75 15"
      stroke="#778092"
      stroke-width="1.5"
      stroke-linecap="round"
      stroke-linejoin="round"
    />
    <path
      d="M11.25 15L14.25 12M14.25 12L17.25 15M14.25 12L14.25 21"
      stroke="#778092"
      stroke-width="1.5"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const WalletIcon = (props: IconProps) => (
  <Icon width="20" height="20" viewBox="0 0 20 20" {...props}>
    <g id="Icon/ Wallet">
      <path
        id="shape"
        d="M11.6667 10V10.0104M4.16667 16.25H15.8333C16.7538 16.25 17.5 15.3173 17.5 14.1667V5.83333C17.5 4.68274 16.7538 3.75 15.8333 3.75H4.16667C3.24619 3.75 2.5 4.68274 2.5 5.83333V14.1667C2.5 15.3173 3.24619 16.25 4.16667 16.25ZM17.5 6.875H11.6667C10.286 6.875 9.16667 8.27411 9.16667 10C9.16667 11.7259 10.286 13.125 11.6667 13.125H17.5V6.875Z"
        stroke="#778092"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
...
export const RotateSwitchIcon = (props: IconProps) => (
  <Icon width="20" height="20" viewBox="0 0 20 20" {...props}>
    <circle cx="10" cy="10" r="10" fill="#383F45" />
    <path
      d="M6 8H14M14 8L12 6M14 8H13M14 12H9H6L8 14"
      stroke="#F6F6FF"
      stroke-width="1.3"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const GasFeeIcon = (props: IconProps) => (
  <Icon width="20" height="20" viewBox="0 0 20 20" {...props}>
    <g id="Frame" clip-path="url(#clip0_1008_27454)">
      <path
        id="Vector"
        d="M3.5 13.5V3.5C3.5 3.23478 3.60536 2.98043 3.79289 2.79289C3.98043 2.60536 4.23478 2.5 4.5 2.5H9.5C9.76522 2.5 10.0196 2.60536 10.2071 2.79289C10.3946 2.98043 10.5 3.23478 10.5 3.5V13.5"
        stroke="#F6F6FF"
        stroke-width="1.25"
        stroke-linecap="round"
        stroke-linejoin="round"
